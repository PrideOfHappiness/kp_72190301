...
<head>
    ...
    <title>Hasil Pencarian Data Pembayaran</title>
</head>
<body>
   ...
   <div class="container-fluid" >
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title"> Hasil Pencarian Data Moda Pembayaran Dari Tanggal {{ $awal }} sampai Tanggal {{ $akhir }} </h3>
...
<script>
        ...
        const data = {
            ...
            datasets: [{
                label: "Jumlah Moda Pembayaran Terhitung",
